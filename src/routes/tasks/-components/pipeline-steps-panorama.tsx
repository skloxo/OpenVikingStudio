...
export const ALL_PANORAMA_STEPS: PanoramaStepDef[] = [
  ...
  },
  {
    ...
    unitEn: 'orphans',
    taskTypes: ['admin_reindex'],
    descriptionZh: '清理已删除或断开关联的孤儿切片与历史悬空记录',
  ...
  },
  {
    ...
    unitEn: 'inodes',
    taskTypes: ['legacy_migration'],
    descriptionZh: '把迁移后的结构化数据原子写入 AGFS 树并落盘',
  ...
  },
  {
    ...
    unitEn: 'orphans',
    taskTypes: ['legacy_cleanup'],
    descriptionZh: '垃圾回收算法执行，清除断链孤儿实体与无效切片',
              ...
              {[
                {
                  key: 'AddResource',
                  nameZh: '资源入库引擎',
                  nameEn: 'Resource Ingestion Engine',
                ...
                },
                {
                  key: 'ExternalParse',
                  nameZh: '文档解析引擎',
                  nameEn: 'Document Parsing Engine',
                ...
                },
                {
                  key: 'Semantic',
                  nameZh: '语义提取引擎',
                  nameEn: 'Semantic Extraction Engine',
                ...
                },
                {
                  key: 'Embedding',
                  nameZh: '向量计算引擎',
                  nameEn: 'Vector Embedding Engine',
                ...
                },
                {
                  key: 'SessionCommit',
                  nameZh: '会话归档引擎',
                  nameEn: 'Session Archival Engine',
                ...
                },
                {
                  key: 'UserDeletion',
                  nameZh: '空间注销引擎',
                  nameEn: 'Namespace Deletion Engine',
                ...
                },
                {
                  key: 'Semantic-Nodes',
                  nameZh: '语义拓扑引擎',
                  nameEn: 'Semantic Topology Engine',
