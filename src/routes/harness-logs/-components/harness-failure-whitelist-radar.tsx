      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <div className="flex flex-col gap-3 rounded-md border border-border/60 bg-card p-4">
          <div className="flex items-center justify-between border-b border-border/60 pb-2.5">
            ...
            <Badge variant="outline" className="text-[11px] font-mono border-cyan-500/30 text-cyan-400">
      ...
      <div className="flex flex-col gap-3 rounded-md border border-border/60 bg-card p-4">
        ...
        {probeResult && (
          <div className="rounded-md border border-cyan-500/30 bg-cyan-500/10 p-3 text-xs">
            ...
            <pre className="mt-2 overflow-x-auto rounded bg-background/80 p-2 font-mono text-[11px] text-foreground">
