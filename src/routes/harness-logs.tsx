...
const BUILTIN_LESSONS: LessonItem[] = [
  ...
  { id: 11, title: '“信雅达”准则与 i18n 顺手即做守则', context: '专业词汇硬翻机械化。', reflection: '破坏用户使用体验。', lesson: '保持信达雅自解释与自然语言契合。' },
  ...
  { id: 15, title: '四色高对比度排版与严禁彩色滥用', context: '视觉杂乱无章。', reflection: '色调干扰核心数据。', lesson: '严禁使用绿色，严格遵从 NO GREEN EVER。' },
