      ...
      <div>
        <div className="flex items-start justify-between gap-2.5">
          <div className="min-w-0">
            <h2 className="truncate text-xs font-semibold uppercase tracking-wider text-[oklch(0.42_0.04_232)] dark:text-[oklch(0.8_0.03_232)]">
              {title}
            </h2>
        ...
        {isLoading ? (
          ...
          <div className="mt-2.5 font-mono text-3xl font-bold leading-none tracking-tight tabular-nums text-foreground">
