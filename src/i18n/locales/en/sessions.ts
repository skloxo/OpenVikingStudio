export const sessions = {
  sessions: {
    ...
    threadList: {
      ...
      filterAll: 'All',
      filterHeartbeat: 'Heartbeats',
      filterBadge: '-{{rate}}% Dehydrated',
      entropyReductionTitle: 'Anti-entropy filter excluded {{count}} automated zero-mutation heartbeat/cron probes ({{rate}} noise reduction)',
      emptyInteractiveTitle: 'No interactive sessions',
      emptyInteractiveDesc: 'Only automated background probes found. Click New Session to start collaborating.',
      emptyHeartbeatTitle: 'No heartbeat sessions',
      emptyHeartbeatDesc: 'No background health check probes or periodic cron sessions detected.',
    },
    chat: {
      copy: 'Copy',
    ...
    quarantine: {
      title: 'Cold Quarantine & Anti-Entropy Dashboard',
      badge: 'v1.5.10 SSOT',
      desc: 'Quarantined Drafts & Reversible Cold Backup Audit · 100% Real Manifest · Safe Dry-Run Probe',
      backToActive: 'Back to Active Sessions',
      metricTargets: 'Quarantined Drafts',
      metricTargetsSub: '100% Isolated, Zero Vector Disturbance',
      metricFiles: 'Quarantined Loose Files',
      metricFilesSub: 'Eliminated Legacy Deadweight Debris',
      metricBytes: 'Net Entropy Freed Space',
      metricBytesSub: 'Disk Reduction Directly Observable',
      metricBatches: 'Archive Batches & Integrity',
      metricBatchesSub: '100% Lossless Dry-Run Reversible',
      targetsUnit: 'drafts',
      filesUnit: 'loose files',
      bytesUnit: 'MB Storage Space',
      batchUnit: 'Batches',
      integrityOk: 'Hash Intact',
      searchPlaceholder: 'Search draft ID or directory name...',
      filterAll: 'All',
      filterZombies: 'Zombie Drafts (1,159)',
      filterStaging: 'Staging Isolation (5)',
      matchedCount: 'Matched {{count}} items',
      rescanTooltip: 'Rescan Archive Manifest',
      dryRunReportTitle: 'Dry-Run Restore Verification Report',
      verifiedPass: 'Zero-Loss Verified',
      verifiedFail: 'Conflict or Corrupted',
      closeReport: 'Close Report',
      archivedFiles: 'Archived Files',
      archivedSize: 'Archived Size',
      targetExists: 'Target Exists',
      targetExistsYes: 'Yes (Conflict)',
      targetExistsNo: 'No (Clean)',
      batchIdLabel: 'Batch ID',
      colTarget: 'Target ID / Name',
      colCategory: 'Category',
      colFiles: 'Files',
      colSize: 'Size',
      colBatch: 'Archive Batch',
