const en = {
  ...
  monitoringPage: {
    ...
    queue: {
      ...
      errors: 'Errors',
      total: 'Total',
      noData: 'No engine data available',
      embedding: 'Vector Embedding Engine',
      semantic: 'Semantic Extraction Engine',
      externalParse: 'Document Parsing Engine',
      addResource: 'Resource Ingestion Engine',
      sessionCommit: 'Session Archival Engine',
      userDeletion: 'Space Purge Engine',
      semanticNodes: 'Semantic Topology Engine',
      totalRow: 'TOTAL',
    },
    retrievalCard: {
  ...
  tasksPage: {
    ...
    pipeline: {
      ...
      pipelineHeader: 'Pipeline Steps',
      durationHeader: 'Duration',
      taskQueueStatus: 'Business Task Status (8 Types)',
      processQueueStatus: 'Execution Engine Status (7 Engines)',
