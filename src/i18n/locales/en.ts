const en = {
  ...
  tasksPage: {
    ...
    gatekeeper: {
      ...
      streamTitle: 'Decision Stream',
      streamSubtitle: 'Real-time admission verdicts and vector similarity evidence',
      add: 'Add Fact',
      ...
      recentDecisions: 'Decision Stream',
      emptyDecisions: 'No decision records yet',
      drawerTitle: 'Decision Explanation',
      ...
      simBandLow: '< 0.92',
      filterAll: 'All',
      searchPlaceholder: 'Filter by ID / URI / Reason...',
    ...
    dualTrack: {
      ...
      emptyBusinessSub: 'All valet ingestion tasks have parked safely into knowledge storage.',
