const en = {
  ...
  retrieval: {
    ...
    benchmark: {
      button: 'Benchmark Drawer',
      drawerTitle: 'RAG Retrieval Benchmark Drawer',
      drawerDesc: 'Batch execute golden test queries to immediately verify Top-1 matching, similarity scores, and millisecond latencies.',
