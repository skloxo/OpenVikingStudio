const en = {
  ...
  tasksPage: {
    ...
    refresh: 'Refresh',
    gatekeeper: {
      title: 'Ingestion Gatekeeper & 4-Way Mutation',
      subtitle: 'Two-stage cosine probe defense and Mem0 proposition mutation (Card-Entropy-01)',
      add: 'Add Fact (ADD)',
      update: 'Refine Fact (UPDATE)',
      delete: 'Supersede (DELETE)',
      noop: 'Deduplicated (NOOP)',
      totalProbes: 'Total Ingestion Probes',
      savedDiskIo: 'Cumulative Disk I/O Saved',
      dedupRate: 'Deduplication Rate',
      recentDecisions: 'Real-time Gatekeeper Decisions',
      emptyDecisions: 'No gatekeeper decision records yet',
      drawerTitle: 'Gatekeeper Decision Explanation',
      inputUri: 'Target Ingestion URI',
      matchedUri: 'Matched Prior Fact',
      similarity: 'Exact Cosine Similarity',
      decisionReason: 'Decision Explanation & Rationale',
      savedBytes: 'Disk Write Saved This Probe',
