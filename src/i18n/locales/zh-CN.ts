const zhCN = {
  ...
  monitoringPage: {
    ...
    queue: {
      ...
      embedding: '向量计算引擎',
      semantic: '语义提取引擎',
      externalParse: '文档解析引擎',
      addResource: '资源入库引擎',
      sessionCommit: '会话归档引擎',
      userDeletion: '空间注销引擎',
      semanticNodes: '语义拓扑引擎',
      totalRow: '合计',
    },
    retrievalCard: {
  ...
  tasksPage: {
    ...
    pipeline: {
      ...
      pipelineHeader: '流水线工序',
      durationHeader: '耗时',
      taskQueueStatus: '业务任务状态 (8 种任务)',
      processQueueStatus: '执行引擎状态 (7 大引擎)',
