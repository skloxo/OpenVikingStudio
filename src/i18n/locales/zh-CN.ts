const zhCN = {
  ...
  tasksPage: {
    ...
    gatekeeper: {
      ...
      streamTitle: '裁决流水',
      streamSubtitle: '写入准入实时判定轨迹与向量对比依据',
      add: '新增写入',
      update: '特例演化',
      delete: '失效清理',
      noop: '印证去重',
      ...
      dedupRate: '去重拦截率',
      recentDecisions: '裁决流水',
      emptyDecisions: '暂无裁决流水记录',
      drawerTitle: '准入裁决自解释',
      inputUri: '写入目标 URI',
      matchedUri: '命中已有事实',
      similarity: '确切余弦相似度',
      decisionReason: '裁决依据自解释',
      savedBytes: '本次节约写入',
      timestamp: '判定时间',
      viewSnippet: '命中参考摘要',
      colTime: '时间',
      ...
      simBandLow: '< 0.92',
      filterAll: '全部',
      searchPlaceholder: '过滤流水号 / URI / 裁决依据...',
      copySuccess: '已复制流水号',
      copyUri: '复制 URI',
    ...
    dualTrack: {
      ...
      emptyBusinessSub: '所有提交任务均已完成异步托管入库，知识库秩序井然。',
      colOpName: '工序名称与摘要',
      colStatus: '状态',
      colStage: '阶段',
      colTime: '执行时间',
