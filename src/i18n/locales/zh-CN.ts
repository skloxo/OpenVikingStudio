const zhCN = {
  ...
  retrieval: {
    ...
    benchmark: {
      ...
      ragasDrawerDesc: '实测 Precision / Recall / Faithfulness / Relevance 综合调和四维指数',
      runBtn: '▶ 开始批量评测',
      ...
      metrics: {
        ...
        precision: 'Context Precision (排布精度)',
        recall: 'Context Recall (知识覆盖)',
        faithfulness: 'Faithfulness (语义忠实度)',
        relevance: 'Answer Relevance (答案相关度)',
      },
      table: {
        query: '测试 Query',
        top1: 'Top-1 匹配项',
