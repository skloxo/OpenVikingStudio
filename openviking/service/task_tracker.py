...
class TaskTracker:
    ...
    async def update_stage(
        ...
        """Update task stage and optionally merge metadata without changing its lifecycle status."""
        await self._dispatcher.run(
            lambda: self._update_stage_on_owner(task_id, stage, account_id, user_id, meta_patch)
        )
