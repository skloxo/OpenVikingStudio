...
| **Task Card 10** | **Viking URI 规范化与 viking://~ 用户家目录** | `viking://~` 用户根路径别名、废除无 UID 模糊简写、Server 入口 URI 规范化校验、Entity URI 大小写对齐 | `a83b8171`, `ff38bb5d`, `1ed5e211`, `81eba498`, `84467b1b` | `pytest tests/test_uri.py` PASS, API URI 路由测试通过 | `v1.3.50` | ⏳ 正在合并开发中 |
