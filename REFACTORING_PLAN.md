...
| **Task Card 2** | **Agent 演进与经验记忆** | Agent 演进服务、经验血缘追踪 (`experience_lineage.py`)、OpenClaw 经验工具 | `61c42e3b`, `73a70195`, `2ced3f15` | `test_api_agent_evolution.py` PASS | `v1.3.5` | ⏳ 待开始 |
...
### 📌 P1-1: [ ] [TASK-RETRIEVAL-TREE-01] 检索测试台 `/retrieval` 页 L0/L1 白盒检索轨迹树与得分渲染
...
### 📌 P1-2: [ ] [TASK-MONITORING-CHARTS-01] 监控页 `/monitoring` Token 节省率与 SLA 时延对比折线图
